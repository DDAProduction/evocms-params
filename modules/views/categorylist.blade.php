...
<!-- App -->
<script type="text/javascript" src="/assets/modules/DDAFilters/codebase/myapp.js?v={{time()}}"></script>
<link rel="stylesheet" type="text/css" href="/assets/modules/DDAFilters/codebase/myapp.css?v={{time()}}">
<div id="appWrap"></div>
